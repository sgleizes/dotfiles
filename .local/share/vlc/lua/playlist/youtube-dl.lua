...
function parse()
  ...
  local file = assert(io.popen('youtube-dl -j --yes-playlist --flat-playlist --format "bestvideo[ext=mp4][height<=720]+bestaudio[ext=m4a]/bestvideo[height<=720]+bestaudio/best[height<=720]/best" "'..url..'"', 'r'))  --run youtube-dl in json mode
  local tracks = {}
  while true do
