...
#+begin_src elisp
(defun +psydev/disable-graphical-modes (frame)
...
(add-hook! 'after-make-frame-functions '+psydev/disable-graphical-modes)
#+end_src
...
(add-hook! 'after-make-frame-functions
  (defun +psydev/fix-etcc-tmux-escape (frame)
    (unless (display-graphic-p frame)
...
(after! persp-mode
  (add-hook! 'after-make-frame-functions
    (defun +psydev/set-persp-save-dir-for-server (_)
