...
*** Frames
Automatically maximize new frames.
#+begin_src elisp
...
*** Evil
Provide more consistent navigation bindings.
...
*** Flyspell
Reduce delay before flyspell is ran on recent changes.
#+begin_src elisp
(after! flyspell
...
*** FIXME Guess language
Automatically detect language for Flyspell.
BUG: Freezes emacs on language detection...
#+begin_src elisp
