...
(after! org-capture
  ...
  (defvar +org-capture-feed-file (concat org-directory "elfeed/feed.org")
  ...
  (add-to-list '+org-capture-frame-parameters '(width . 0.42))
...
(use-package! visual-fill-column
  ...
  (add-hook! (helpful-mode elfeed-show-mode)
