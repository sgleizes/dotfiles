...
(defun maker/font-settings ()
  ...
  (set-fontset-font t ? "Weather Icons" nil 'prepend)
  (set-fontset-font t ? "Weather Icons" nil 'prepend))
...
(after! pretty-hydra
  (pretty-hydra-define +hydra/window-management
    (:separator "═" :title (+hydra/title-generator "Window Management" "windows" 53))
    ("Switch"
...
(after! pretty-hydra
  (pretty-hydra-define +hydra/buffer-management
    (:hint nil :separator "═" :title (+hydra/title-generator "Buffer Management" "files-o" 36))
    ("Tabs"
